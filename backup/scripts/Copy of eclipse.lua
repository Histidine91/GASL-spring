...
--core hull pieces
local hullMain, head, hullLeft, hullRight, hullAft = piece "hullmain", piece "head", piece "hulll", piece "hullr", piece "hullaft"
local noseLeft, noseRight, plateLeft, plateRight = piece "nosel", piece "noser", piece "platel", piece "plater"
--main hull weapons
local turretBaseAM, turretAM, flareAM, grav = piece "amturretbase", piece "amturret", piece "amflare", piece "grav"
local droneLeft, droneRight, megaLaser = piece "dronel", piece "droner", piece "megalaser"
--kinetic
local turretKForeLeft, sleeveKForeLeft, barrel1KForeLeft, barrel2KForeLeft, flare1KForeLeft, flare2KForeLeft = piece "kturret_fore_l", piece "ksleeve_fore_l", piece "kbarrel1_fore_l", piece "kbarrel2_fore_l", piece "kflare1_fore_l", piece "kflare2_fore_l"
local turretKForeRight, sleeveKForeRight, barrel1KForeRight, barrel2KForeRight, flare1KForeRight, flare2KForeRight = piece "kturret_fore_l", piece "ksleeve_fore_l", piece "kbarrel1_fore_l", piece "kbarrel2_fore_l", piece "kflare1_fore_l", piece "kflare2_fore_l"
local turretKMidLeft, sleeveKMidLeft, barrel1KMidLeft, barrel2KMidLeft, flare1KMidLeft, flare2KMidLeft = piece "kturret_mid_l", piece "ksleeve_mid_l", piece "kbarrel1_mid_l", piece "kbarrel2_mid_l", piece "kflare1_mid_l", piece "kflare2_mid_l"
local turretKMidRight, sleeveKMidRight, barrel1KMidRight, barrel2KMidRight, flare1KMidRight, flare2KMidRight = piece "kturret_mid_l", piece "ksleeve_mid_l", piece "kbarrel1_mid_l", piece "kbarrel2_mid_l", piece "kflare1_mid_l", piece "kflare2_mid_l"
local turretKAftLeft, sleeveKAftLeft, barrel1KAftLeft, barrel2KAftLeft, flare1KAftLeft, flare2KAftLeft = piece "kturret_aft_l", piece "ksleeve_aft_l", piece "kbarrel1_aft_l", piece "kbarrel2_aft_l", piece "kflare1_aft_l", piece "kflare2_aft_l"
local turretKAftRight, sleeveKAftRight, barrel1KAftRight, barrel2KAftRight, flare1KAftRight, flare2KAftRight = piece "kturret_aft_l", piece "ksleeve_aft_l", piece "kbarrel1_aft_l", piece "kbarrel2_aft_l", piece "kflare1_aft_l", piece "kflare2_aft_l"
--PDLs
local turretPDFore, sleevePDFore, barrelPDFore, flarePDFore = piece "lturret_fore", piece "lsleeve_fore", piece "lbarrel_fore", piece "lflare_fore"
local turretPDLeft, sleevePDLeft, barrelPDLeft, flarePDLeft = piece "lturret_mid_l", piece "lsleeve_mid_l", piece "lbarrel_mid_l", piece "lflare_mid_l"
local turretPDRight, sleevePDRight, barrelPDRight, flarePDRight = piece "lturret_mid_r", piece "lsleeve_mid_r", piece "lbarrel_mid_r", piece "lflare_mid_r"
local turretPDAft, sleevePDAft, barrelPDAft, flarePDAft = piece "lturret_aft", piece "lsleeve_aft", piece "lbarrel_aft", piece "lflare_aft"
--plasma
local turretPLeft, sleevePLeft, barrelPLeft, flarePLeft = piece "pturret_l", piece "psleeve_l", piece "pbarrel_l", piece "pflare_l"
local turretPRight, sleevePRight, barrelPRight, flarePRight = piece "pturret_r", piece "psleeve_r", piece "pbarrel_r", piece "pflare_r"
--missiles
local turretMLeft, pod1MLeft, pod2MLeft, flare1MLeft, flare2MLeft = piece "mturret_l", piece "mpod1_l", piece "mpod2_l", piece "mflare1_l", piece "mflare2_l"
local turretMRight, pod1MRight, pod2MRight, flare1MRight, flare2MRight = piece "mturret_r", piece "mpod1_r", piece "mpod2_r", piece "mflare1_r", piece "mflare2_r"
--torpedoes
local torp1, torp2, torp3, torp4, torp5, torp6 = piece "torp1", piece "torp2", piece "torp3", piece "torp4", piece "torp5", piece "torp6"
...
local turretSpeedK = 360
local sleeveSpeedK = 240
local turretSpeedP = 120
local sleeveSpeedP = 80
local turretSpeedM = 240
local podSpeedM = 160
...
local function aimWeaponKinetic(heading, pitch, turret, sleeve, weaponNum)
	return aimTurret(turret, sleeve, turretSpeedK, sleeveSpeedK, weaponNum)
end
...
function script.AimWeapon1(heading, pitch)
	...
	return aimTurret(heading, pitch, turretAM, turretAM, 90, 60, 1)
end
