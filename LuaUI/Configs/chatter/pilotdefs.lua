	...
	happytrigger = {
		...
		dialogue = {
			...
			unitDamaged_minor_received = {
				...
				{image = portraits.forte_what, text = "It's going to take more than that to get through the Happy Trigger's armor."},
				minor = colors.violet .. "Happy Trigger\008 is " .. colors.yellow .. "20% damaged\008!"
			},
			criticalHit = {
				{image = portraits.forte_confident, text = "Do ya feel lucky, punk? Do ya?"},
			},
			criticalHit_received = {
