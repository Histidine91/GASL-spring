...
local weapons = {
	...
	{aimFrom = lturret_f, yaw = lturret_f, pitch = lpivot_f, muzzles = {lflare1_f, lflare2_f}, emit = 1028 },
	{aimFrom = lturret_b, yaw = lturret_b, pitch = lpivot_b, muzzles = {lflare1_b, lflare2_b}, emit = 1028 },
