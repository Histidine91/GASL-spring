...
backgrounds = {
  {check={},                                                 texture="LuaRules/Images/IconGenBkgs/bg_blank.png"},
}
...
defaults = {border=0.05, angle=40, rot="right", clamp=-10000, scale=1.5, empty=false, attempts=10, wait=120, zoom=1.0, offset={0,0,0},unfold=true};
...
for i=1,#UnitDefs do
  if (UnitDefs[i].canKamikaze) then
